...
public:
	...
	virtual bool Create(int socket_fd){ return false; }; //build a socket by sockfd, used in server accept a client
	virtual bool GetPeerAddr(){ return false; };
